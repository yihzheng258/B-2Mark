...
class B2MarkWatermarkEmbedding:
    def __init__(self, dataset="housing", seed=10000, k=10, g=3, gamma=1/2, secret_key="123", columns_of_interest = ['RM', 'AGE']):
...
class B2MarkWatermarkDetection:
    def __init__(self, dataset, secret_key, k=10, g=3, seed=10000, columns_of_interest=['RM', 'AGE']):
        self.dataset = dataset
        self.secret_key = secret_key
        self.k = k
        self.g = g
